    ...
    <div className="page">
      <main className="card">
        ...
        <p className="lede">
          ...
          this app&apos;s <code>/api/acuris</code> routes). Pick one to
          autofill the fields below, then submit to run a full validate pass.
        </p>
        ...
        <div className="field">
          ...
          <AcurisAddressInput
            ...
            value={search}
            onChange={(v) => {
              // Defensive flatten in case an older centra-checkout version is
              // ever pinned — modern versions return a single-line display.
        ...
        {picked && (
          <div className="status status-info">
            ...
            <div>
              ...
              {picked.formatted_address ?? "(no formatted address)"}
